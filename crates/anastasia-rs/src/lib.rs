...
pub use api::{
    ...
    prove_ca, prove_chain, prove_chain_as_key_attestation_jwt, prove_chain_base64,
    prove_chain_composed, prove_chain_composed_aka,
    prove_chain_composed_aka_as_key_attestation_jwt, prove_chain_composed_aka_base64,
    prove_chain_composed_as_key_attestation_jwt, prove_chain_composed_base64, prove_ee, setup,
};
